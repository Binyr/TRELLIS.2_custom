...
def process_geometry(args):
    ...
    for view_idx in render_view_indices:
        ...
        # Per-view RNG => same lights across resumes of the same view.
        ...
        try:
            ...
            # Per-view mesh.npz (self-contained, redundant on purpose).
            ...
            timer.log(f"render {view_name}")
        except Exception as e:
            err_msg = f"{type(e).__name__}: {e}"
            print(f"[ERROR] view {view_name} failed: {err_msg}")
