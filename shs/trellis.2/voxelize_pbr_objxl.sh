...
ANN_FILE="${ANN_FILE:-$DATA_ROOT/objxl/dynamic_obj_voxel_32f_latent/1024/anns_objxl.json}"
...
S3_PBR_ROOT="${S3_PBR_ROOT:-s3://arcwm-code-us-west-2/yanruibin/efs/4D_video_data_process/data/objxl/dynamic_obj_pbr_shared}"
S3_OUTPUT_ROOT="${S3_OUTPUT_ROOT:-s3://arcwm-code-us-west-2/yanruibin/efs/4D_video_data_process/data/objxl/dynamic_obj_pbr_voxelized}"
LOCAL_CACHE_ROOT="${LOCAL_CACHE_ROOT:-/local-ssd/voxelize_pbr_objxl_cache}"
LOCAL_TMP_ROOT="${LOCAL_TMP_ROOT:-/local-ssd/tmp_voxelize_pbr_objxl}"
LOCAL_STATE_ROOT="${LOCAL_STATE_ROOT:-/local-ssd/voxelize_pbr_objxl_state}"
LOCAL_STDOUT_DIR="${LOCAL_STDOUT_DIR:-/local-ssd/voxelize_pbr_objxl_stdouts}"
...
echo "================================================================"
echo "[voxelize_pbr_objxl] host=$(hostname) rank=$RANK/$WS"
