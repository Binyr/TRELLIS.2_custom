#!/bin/bash
# Encode O-Voxel 4D view tars (from objxl_dual_grid_4d.sh) into shape+SS latents.
# Single-process, single-GPU per rank; spawn multiple ranks across pods via koala.
#
...
S3_OUTPUT="s3://arcwm-code-us-west-2/yanruibin/efs/4D_video_data_process/data/objxl/dynamic_obj_voxel_32f_latent"
...
VOXEL_LOGS_PREFIX="s3://arcwm-code-us-west-2/yanruibin/efs/4D_video_data_process/data/objxl/dynamic_obj_voxel_32f/logs${LOG_SUFFIX}/"
...
LOCAL_STDOUT_DIR="/local-ssd/encode_objxl_stdouts${LOG_SUFFIX}"
...
echo "================================================================"
echo "[encode:objxl] host=$(hostname) rank=$RANK/$WS res=$RESOLUTION ss_res=$SS_RESOLUTION"
