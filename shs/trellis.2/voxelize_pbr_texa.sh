...
ANN_FILE="${ANN_FILE:-$DATA_ROOT/texverse_1k_animate/texverse_A_voxel_latent/1024/anns_texverse_A.json}"
...
S3_PBR_ROOT="${S3_PBR_ROOT:-s3://arcwm-code-us-west-2/yanruibin/efs/4D_video_data_process/data/texverse_1k_animate/pbr_A_voxel}"
S3_OUTPUT_ROOT="${S3_OUTPUT_ROOT:-s3://arcwm-code-us-west-2/yanruibin/efs/4D_video_data_process/data/texverse_1k_animate/pbr_A_voxelized}"
LOCAL_CACHE_ROOT="${LOCAL_CACHE_ROOT:-/local-ssd/voxelize_pbr_texa_cache}"
LOCAL_TMP_ROOT="${LOCAL_TMP_ROOT:-/local-ssd/tmp_voxelize_pbr_texa}"
LOCAL_STATE_ROOT="${LOCAL_STATE_ROOT:-/local-ssd/voxelize_pbr_texa_state}"
LOCAL_STDOUT_DIR="${LOCAL_STDOUT_DIR:-/local-ssd/voxelize_pbr_texa_stdouts}"
...
echo "================================================================"
echo "[voxelize_pbr_texa] host=$(hostname) rank=$RANK/$WS"
