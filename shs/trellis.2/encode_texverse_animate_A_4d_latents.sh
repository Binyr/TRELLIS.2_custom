...
VOXEL_LOGS_PREFIX="s3://arcwm-code-us-west-2/yanruibin/efs/4D_video_data_process/data/texverse_1k_animate/texverse_A_voxel/logs/"
...
LOCAL_STDOUT_DIR=/local-ssd/encode_texverse_A_stdouts
