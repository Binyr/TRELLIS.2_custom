#!/bin/bash
# Encode O-Voxel 4D view tars (from texverse_animate_dual_grid_4d.sh) into
# shape (+ optional SS) latents. TexVerse-Animation Stage A flavor.
#
...
S3_INPUT="s3://arcwm-code-us-west-2/yanruibin/efs/4D_video_data_process/data/texverse_1k_animate/texverse_A_voxel"
S3_OUTPUT="s3://arcwm-code-us-west-2/yanruibin/efs/4D_video_data_process/data/texverse_1k_animate/texverse_A_voxel_latent"
...
VOXEL_LOGS_PREFIX="s3://arcwm-code-us-west-2/yanruibin/efs/4D_video_data_process/data/texverse_1k_animate/texverse_A_voxel/logs${LOG_SUFFIX}/"
...
LOCAL_STDOUT_DIR="/local-ssd/encode_texverse_A_stdouts${LOG_SUFFIX}"
...
echo "================================================================"
echo "[encode:texverseA] host=$(hostname) rank=$RANK/$WS res=$RESOLUTION ss_res=$SS_RESOLUTION"
