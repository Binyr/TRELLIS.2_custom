#!/bin/bash
# Multi-process launcher for TexVerse-Animation rendering.
# (Copy of render_dynamic_obj_mp.sh with paths + batch driver swapped.)
#
# Per pod:
...
# Config (texverse_animate).
BLENDER_PATH="/tmp/blender-4.5.1-linux-x64/blender"
MANIFEST="/threed-code/yanruibin/efs/4D_video_data_process/data/texverse_1k_animate/texverse_animate_manifest.json"
S3_OUTPUT_ROOT="s3://arcwm-code-us-west-2/yanruibin/efs/4D_video_data_process/data/texverse_1k_animate/rendered_v1"
LOCAL_OUTPUT_ROOT="/local-ssd/texverse_animate_rendered"
LOCAL_TMP_ROOT="/local-ssd/texverse_animate_tmp"
LOCAL_STATE_ROOT="/local-ssd/texverse_animate_state"
LOCAL_LOG_ROOT="/local-ssd/texverse_animate_logs"
