...
for i in $(seq 0 $((num_chunk-1))); do
    ...
    -c "cd /data/work/run_codes && ls -lh && source uv/setup.sh --new-env --venv-dir /local-ssd/vpixal3d-venv && export HF_TOKEN=\$HF_TOKEN && bash shs/download_dynamic_obj.sh $num_chunk $i" \
